...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", type=str, default="../pretrain_file/bert_base_uncased")
    ...
    parser.add_argument("--input_dir", type=str, default="../processed2018/combined_maxsim16_ours")
